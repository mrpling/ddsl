...
Spec-first: behavior follows spec.md, DDSL v0.4.1 may change; breaking changes will be noted in CHANGELOG.md

## Specification

Full specification, [DDSL v0.4.1 spec](https://github.com/mrpling/ddsl/blob/main/spec.md) 
